...
# ----------- Views for recommendation Filters -------------------#

class Solutions_vech_tran_energy(db.Model):
    __tablename__ = 'v_recommendations_vech_tran_energy'
    recommendations_id = db.Column(db.Integer, primary_key=True)
    section = db.Column(db.Text)
    subsection = db.Column(db.Text)
    solution_description = db.Column(db.Text)
...
class Solutions_energy(db.Model):
    __tablename__ = 'v_recommendations_energy'
    recommendations_id = db.Column(db.Integer, primary_key=True)
    section = db.Column(db.Text)
    subsection = db.Column(db.Text)
    solution_description = db.Column(db.Text)
...
class Solutions_energy_waste(db.Model):
    __tablename__ = 'v_recommendations_energy_waste'
    recommendations_id = db.Column(db.Integer, primary_key=True)
    section = db.Column(db.Text)
    subsection = db.Column(db.Text)
    solution_description = db.Column(db.Text)
...
class Solutions_vech_tran(db.Model):
    __tablename__ = 'v_recommendations_vech_tran'
    recommendations_id = db.Column(db.Integer, primary_key=True)
    section = db.Column(db.Text)
    subsection = db.Column(db.Text)
    solution_description = db.Column(db.Text)
...
class Solutions_waste(db.Model):
    __tablename__ = 'v_recommendations_waste'
    recommendations_id = db.Column(db.Integer, primary_key=True)
    section = db.Column(db.Text)
    subsection = db.Column(db.Text)
    solution_description = db.Column(db.Text)
...
class Solutions_waste_vech_tran(db.Model):
    __tablename__ = 'v_recommendations_waste_vech_tran'
    recommendations_id = db.Column(db.Integer, primary_key=True)
    section = db.Column(db.Text)
    subsection = db.Column(db.Text)
    solution_description = db.Column(db.Text)
